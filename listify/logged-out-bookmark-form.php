<div class="job-manager-form wp-job-manager-bookmarks-form">
	<div class="bookmark-action">
		<a class="popup-trigger-ajax bookmark-notice--logged-out" href="<?php echo apply_filters( 'job_manager_bookmark_form_login_url', wp_login_url( get_permalink() ) ); ?>">
			<span class="screen-reader-text"><?php printf( __( 'Login to bookmark this %s', 'listify' ), $post_type->labels->singular_name ); ?></span>
		</a>
