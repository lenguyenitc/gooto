...
class Listify_WP_Job_Manager_Business_Hours extends Listify_Integration {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'timepicker', Listify_Integration::get_url() . 'js/vendor/timepicker/jquery.timepicker.min.js' );
		wp_enqueue_style( 'timepicker', Listify_Integration::get_url() . 'js/vendor/timepicker/jquery.timepicker.css' );
	}
